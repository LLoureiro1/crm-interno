  ...
  return (
    <div className="space-y-6">
      ...
      {grouped.map(group => {
        ...
        const unitLabels = f?.unit_ids?.length ? f.unit_ids : [];
        const seriesLabels = f?.series_ids?.length ? f.series_ids : [];
        const classLabels = f?.class_ids?.length ? f.class_ids : [];
                      ...
                      <TableRow key={item.id}>
                        ...
                        <TableCell className="text-sm">
                          <Button
                            ...
                            title="Clique com o botão direito para abrir"
                          >
