-- Add 'ausente' status to the student_status enum
ALTER TYPE student_status ADD VALUE 'ausente';

-- Add 'atendimento_ha_mais_de_uma_semana' status to the student_status enum  
ALTER TYPE student_status ADD VALUE 'atendimento_ha_mais_de_uma_semana';
