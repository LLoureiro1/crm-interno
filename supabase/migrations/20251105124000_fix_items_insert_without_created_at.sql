-- Ajusta a função de popular itens para não inserir coluna inexistente
-- Remove o uso de created_at em INSERT de contact_list_items (erro 42703)
...
BEGIN
  ...
  -- OBS: Não inclui created_at, pois a coluna não existe na tabela em alguns ambientes
...
-- Nota: Não é necessário recriar gatilhos; eles já apontam para esta função.