-- Ajuste na validação de horário no passado considerando o fuso horário de Brasília (America/Sao_Paulo)
...
BEGIN
  ...
  -- Se a data for hoje ou antes de hoje, validamos se o horário já passou
