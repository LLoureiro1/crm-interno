-- Recência: baseada em contato bem-sucedido (não tentativa falha nem updated_at)
...
BEGIN
  ...
  IF v_days_since_successful_contact <= 3 THEN
    v_recencia := 8;
  ...
  -- Penalidade extra: tentativas sem sucesso nos últimos 90 dias
  SELECT COUNT(*)::int
